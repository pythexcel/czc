...
const FAQs = () => {
  const buttonsData = [
    { text: "Enable All Locations", onClick: () => {} },
    { text: "Disable All Locations", onClick: () => {} },
              ...
              <tr>
                <td className="py-4 px-[2%] text-xl text-[#8392AB]">
                  <input
                    ...
                    type="checkbox"
                    value=""
                    class="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 rounded-lg focus:ring-blue-500"
                  />
                </td>
                ...
                <td className="py-4 px-4 bg-slate-50 text-xl flex justify-center mt-[5%]  text-[#8392AB]">
