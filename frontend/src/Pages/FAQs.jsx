          ...
          <table className="w-full border-collapse rounded-lg  ">
            <thead>
              <tr className="bg-blue-100 ">
                ...
                <th className="py-4 font-medium text-[#8392AB]">
                  SUB-ACCOUNTS NAME{" "}
                </th>
                <th className="py-4 font-medium px-4 text-[#8392AB]">
                  NO OF FAQS
                </th>
                <th className="py-4 font-medium px-4 text-[#8392AB]">
                  ENABLED
            ...
            <tbody>
              <tr>
                <td className="py-4 px-[2%] text-xl text-[#8392AB]">
                  <input
                    id="link-checkbox"
                    type="checkbox"
                    value=""
                ...
                <td className="py-4 px-4 bg-slate-50 text-xl text-center text-[#8392AB]">
                  180 Transformations
                </td>
                <td className="py-4 px-4 bg-slate-50 text-xl text-center text-[#8392AB]">
                  20
                </td>
                <td className="py-4 px-4 bg-slate-50 text-xl flex justify-center mt-[8%]  text-[#8392AB]">
                ...
                <td className="py-4 px-4 text-xl">
                  <div className=" flex justify-center ">
                    <div className="mr-[5%]  p-4 text-[#8392AB] shadow-lg px-2 py-2 bg-opacity-17 bg-[#f8fafc] rounded-lg flex justify-center items-center">
                      <FaFileExport />
                    </div>
                    <div className="text-[#8392AB]  p-4 shadow-lg px-2 py-2 bg-opacity-17 bg-[#f8fafc] rounded-lg flex items-center">
                      <FaFileImport />
                    </div>
                    <div className="flex align-center ml-[5%]  mr-[3%] p-4 shadow-lg px-2 py-2 bg-opacity-17 bg-[#f8fafc] rounded-lg">
                      <i className="text-[#8392AB] mr-[2%] mt-[6%]">
                        <AiFillEye />
                      </i>
                      <h6 className="text-[#8392AB]">Widget</h6>
                    </div>
                    <div className="flex ml-[2%] mr-[2%]  shadow-lg px-2 py-2 bg-opacity-17 bg-[#f8fafc] rounded-lg items-center">
                      <i className="text-[#8392AB] mr-[2%] mt-[6%]">
                        <MdDelete />
                      </i>
