    ...
    return (
        <div className="gap-6 my-4 border border-blue-500 rounded-2xl p-4 -mx-4">
            ...
            <div className="w-[75%]">
                ...
                <InputField type="text" placeholder="https://app.zappychat/example/webhook" />
            </div>
            ...
            {headers.map((index) => (
                <InputHeaders onDelete={handleDelete} index={index} key={index} />
            ))}

            <div className="flex gap-6 p-4 items-top">
                <div className="w-[20%]">
